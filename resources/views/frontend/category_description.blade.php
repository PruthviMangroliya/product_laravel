         ...
         <div class="imgBnrOuter">
             <div class="container" style="align-items:center">
                 <div class="row">
                     ...
                     <div class="col-12 col-sm-12 col-md-3 col-lg-3 item">
                         <div class="img-bnr">
                             <div class="inner center">
                                 <a href="{{ url('frontend/subcategory/'.$subcategory->subcategory_id) }}">
                                     <img data-src="{{ asset($subcategory->subcategory_image) }} " src="{{ asset($subcategory->subcategory_image) }} " alt="Cap" title="Cap" class="blur-up lazyload" />
     ...
     <div class="container">
         ...
         <div class="row">
             <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                 <div class="wrap-blog">
                     <a href="blog-left-sidebar.html" class="article__grid-image">
                         <img src="{{ asset('frontend_assets/images/blog/post-img1.jpg') }}" alt="It's all about how you wear" title="It's all about how you wear" class="blur-up lazyloaded" />
                     </a>
             ...
             <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                 <div class="wrap-blog">
                     <a href="blog-left-sidebar.html" class="article__grid-image">
                         <img src="{{ asset('frontend_assets/images/blog/post-img2.jpg') }}" alt="27 Days of Spring Fashion Recap" title="27 Days of Spring Fashion Recap" class="blur-up lazyloaded" />
                     </a>
                     <div class="article__grid-meta article__grid-meta--has-image">
                         <div class="wrap-blog-inner">
                             <h2 class="h3 article__title">
